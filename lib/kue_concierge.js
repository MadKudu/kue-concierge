...
KueConcierge.prototype.clearExpiredComplete = function() {
	var instance = this;
	return Q.npost(this.kue.Job, 'rangeByState', ['complete', 0, instance.batchSize - 1, 'asc'])
		.then(function (jobs) {
			jobs.forEach(function (job) {
...
KueConcierge.prototype.clearExpiredFailed = function() {
	var instance = this;
	return Q.npost(this.kue.Job, 'rangeByState', ['failed', 0, instance.batchSize - 1, 'asc'])
		.then(function (jobs) {
			jobs.forEach(function (job) {
...
KueConcierge.prototype.removeBatch = function(batchSize) {
	return Q.npost(this.kue.Job, 'rangeByState', ['complete', 0, batchSize - 1, 'asc'])
		.then(function (jobs) {
			jobs.forEach(function (job) {
				console.log('Removing job ' + job.id + ' (complete)');
				job.remove();
